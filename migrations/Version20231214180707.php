 ...
 */
final class Version20231214180707 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE participer CHANGE id_animal_id animal_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX `PRIMARY` ON participer');
        $this->addSql('ALTER TABLE participer CHANGE animal_id id_animal_id INT NOT NULL');
        ...
        $this->addSql('ALTER TABLE participer ADD PRIMARY KEY (id_animal_id, evenement_id)');
    }
}

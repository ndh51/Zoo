 ...
 */
final class Version20231214181017 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE animal CHANGE id_famille_id famille_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE animal CHANGE famille_id id_famille_id INT DEFAULT NULL');
